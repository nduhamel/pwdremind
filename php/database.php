    ...
    public function __destruct() {
        ...
        public function store_entry($data, $username) {
            if ($this->_driver == 'pgsql'){
                $req = $this->_db->prepare("INSERT INTO data (data, username)  VALUES(:data, :username)  RETURNING id");
        ...
        public function update_entry($id,$data, $username) {
            $req = $this->_db->prepare("UPDATE data SET data=:data WHERE id=:id AND username=:username ");
